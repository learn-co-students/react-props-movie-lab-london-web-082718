  ...
  render() {
    return (
      <div className="movie-card">
        ...
        <CardFront poster={posterMap[this.props.poster] || undefined}/>
        <CardBack title={this.props.title || undefined} IMDBRating={this.props.IMDBRating || undefined} genres={this.props.genres || undefined}/>
      </div>
    )
  }
}
